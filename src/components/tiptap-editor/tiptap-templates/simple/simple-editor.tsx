...
export function SimpleEditor({
  ...
  return (
    <div className="group simple-editor-content relative flex w-full flex-col">
      <EditorContext.Provider value={{ editor }}>
        <Toolbar
          ref={toolbarRef}
          className="bg-background/80 rounded-2xl border shadow-xl transition-all duration-300"
          style={{
            ...(isMobile
              ? {
